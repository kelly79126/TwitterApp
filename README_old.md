...
* [V]	User can **view tweets from their home timeline**
  ...
  * [V] User can view more tweets as they scroll with [infinite pagination](http://guides.codepath.com/android/Endless-Scrolling-with-AdapterViews-and-RecyclerView). Number of tweets is unlimited.
...
* [V] Replace all icon drawables and other static image assets with [vector drawables](http://guides.codepath.com/android/Drawables#vector-drawables) where appropriate.
...
[Link to Video Walkthrough](https://www.dropbox.com/s/icog4oepuyyui3b/HW3_high.mp4?dl=0)
